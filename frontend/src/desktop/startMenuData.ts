...
export const allProgramsMenu: StartMenuEntry[] = [
  ...
  { type: 'separator' },
  {
    ...
    items: [
      ...
      { type: 'item', icon: xpIcon('156(16x16).png'), label: 'Explorateur Windows' },
  ...
  },
  {
    ...
    items: [
      ...
      { type: 'item', icon: xpIcon('heart.png'), label: 'Hearts' },
      ...
      { type: 'item', icon: '/xp/winxp-icons/minesweeper/mine-icon.png', label: 'Minesweeper' },
